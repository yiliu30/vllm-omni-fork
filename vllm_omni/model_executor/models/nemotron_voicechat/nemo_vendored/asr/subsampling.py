...
# Vendored from NVIDIA-NeMo/Speech (branch nemotron-labs-voicechat) nemo/collections/asr/parts/submodules/subsampling.py; training-only code removed.
...
from .causal_convs import CausalConv1D, CausalConv2D
