...
### 1. Reproduce the Triton-XPU sparse executor unit/e2e checks
...
### 2. Reproduce the 9-frame Wan run with Triton-XPU sparse self-attention

This is the exact configuration used for the successful reduced Wan smoke:
...
### 3. Extract the generated frames
